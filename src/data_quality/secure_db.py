...
class SecureDatabaseError(OperationError):
    ...
    def __init__(self, operation: str, reason: str, suggestion: Optional[Optional[str]] = None) -> None:
...
if __name__ == "__main__":
    ...
    print("\n🛡️ Security Features:")
    print("  • Server-side timeouts (PostgreSQL statement_timeout, MySQL max_execution_time)")
